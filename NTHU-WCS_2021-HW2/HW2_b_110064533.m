...
%  (b) If v = 90 km/hr and f_c = 26 GHz, find the cdf and the pdf of the
%      observed Doppler shift via simulation.
% 
clear;
clc;
%
...
v = 90*1000/(60*60);  % MS velocity v = 90 km/hr = 20*1000/3600 m/sec
% 
fc = 26*1e9;          % unmodulated carrier frequency f_c = 26 GHz
...
plot(x, fDn_num, 'Color', [1, 0, 0], 'LineWidth', 1.5, 'LineStyle', '-'); 
legend('PDF', 'Location', 'best');
xlabel('the observed Doppler shift (v = 90 km/hr, f_c = 26 GHz)');
ylabel('the Probability Density Function');
title('the simulated PDF of the observed Doppler shift');
% save the plot as 'HW2_b_pdf_110064533.png'
% print('HW2_b_pdf_110064533.png', '-dpng');
%
% 
...
% save the plot as 'HW2_b_cdf_110064533.png'
% print('HW2_b_cdf_110064533.png', '-dpng');
% 
% 
